create materialized view ptm_metadata_arguments as
select case
...
create index ptm_metadata_arguments_in01 on
  ptm_metadata_arguments(package_name, method_name, subprogram_id)
;
