create or replace package body ptp_plsql_block_generator as
  ...
  (
    ...
    p_in_out        ptp_plsql_block_generator.gtyp_in_out
  ) is
    with type_attrs as
     (
      ...
      select case p_in_out
        ...
        join ptm_metadata_methods_api_types m on (a.package_name = m.package_name and
    ...
    loop
      ...
      loop
        ...
        execute_ddl_statement(p_statement_in    => get_arguments_type_spec(p_package_name_in  => lrec_method.package_name,
                                                                           ...
                                                                           p_in_out_in        => ptp_plsql_block_generator.gc_argument_in,
        ...
        execute_ddl_statement(p_statement_in    => get_arguments_type_spec(p_package_name_in  => lrec_method.package_name,
                                                                           p_method_name_in   => lrec_method.method_name,
                                                                           p_in_out_in        => ptp_plsql_block_generator.gc_argument_out,
                                                                           p_subprogram_id_in => lrec_method.subprogram_id),
                              p_package_name_in => lrec_method.method_name,
                              p_method_name_in  => lrec_method.method_name);
        --
